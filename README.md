# **🎓 ProAnalyst - 個人化學程潛能分析師**

這是一個專為國立政治大學學生設計的開源工具「ProAnalyst」，透過上傳從校務全人系統匯出的「課業學習」JSON 檔案，即可快速檢核學分學程或微學程的修習進度，並提供智慧推薦功能，挖掘您潛在的學程資格。
...
5. **安裝 App：** 在支援的瀏覽器中，點擊網址列的安裝圖示或「加到主畫面」，即可將 ProAnalyst 安裝至您的裝置。
